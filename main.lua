...
DefaultMaxInventoryWeight = 3000.0 -- Default value 300.0.
...
bossTechnologyPointPerTowerBoss = 5 -- Default value 5. Not tested.

-- Technology points gained per normal boss?
bossTechnologyPointPerNormalBoss = 1 -- Default value 1. Not tested.

-- Technology points gained per fast travel point?
TechnologyPoint_UnlockFastTravel = 1 -- Default value 1. Not tested.
...
worldmapUIMaskClearSize = 999999 -- Default value 36.0.
...
RarePal_LevelMultiply = 1.5 -- Default 1.5. Not tested.
